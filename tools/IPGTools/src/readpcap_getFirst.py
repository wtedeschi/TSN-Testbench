...
class TrafficClass:
    ...
    def processPkt(self, pkt, deltaPktTime_threshold, initialTime):
        ...
        print(pkt.time,(pkt.time - self.prevPktTime))
        ...
        self.DeltaTime.append(float(self.deltaPktTime))
    ...
    def getDataFrameIPG(self):
        ...
        print(title)
        self.dataframeIPG = pd.DataFrame(self.DeltaTime[1:])
    ...
    def getStats(self):
        ...
        if len(self.framesWithinCycle[:]) > 0:    
